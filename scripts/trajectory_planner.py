...
if __name__ == '__main__':
	...
	postument.move_to_joint_position([-1.38227752354415, -1.541861095576026, 5.504115800705756e-05, 1.0007174886590251, 4.754815971689398, -1.91731301362624], 3.0)
	...
	for i in range(1,len(joints)):
		points.append( JointTrajectoryPoint(joints[i], vels[i], [], [], rospy.Duration(i*5.0)) )
